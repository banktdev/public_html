<div class="container" style="padding: 1%">
    ...
    ?>
        ...
        <div class="col-6">
            <div class="m-1">
                <a <?php if ($_SESSION['Credit'] > 0) : ?> href="sa_room.php?id=<?php echo $i + 1; ?>&title=<?php echo $room . str_pad($J, 2, '0', STR_PAD_LEFT); ?>" <?php else : ?> onclick="Swal.fire({ type: 'error',title: 'คุณมี Credit ไม่พอใช้บริการนี้',text: 'กรุณาเติมเงินก่อนเข้าใช้งานต่อไปค่ะ'})" <?php endif; ?>>
