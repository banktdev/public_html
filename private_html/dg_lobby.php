...
$views_page = array(
    1  => array("page" => "resource/views/dg_lobby_1.php"),
    2  => array("page" => "resource/views/dg_lobby_2.php"),
    3  => array("page" => "resource/views/dg_lobby_3.php"),
    4  => array("page" => "resource/views/dg_lobby_4.php"),
    5  => array("page" => "resource/views/dg_lobby_5.php"),
    6  => array("page" => "resource/views/dg_lobby_6.php"),
    7  => array("page" => "resource/views/dg_lobby_7.php"),
    8  => array("page" => "resource/views/dg_lobby_8.php"),
    9  => array("page" => "resource/views/dg_lobby_9.php"),
    10 => array("page" => "resource/views/dg_lobby_10.php"),
);
...
<head>
  ...
  <script type="text/javascript" src="./js/dg_lobby.js?v=<?=$v ?>"></script>
