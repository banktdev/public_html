...
<head>
  ...
  <title>Baccarat | Admin Login</title>
  <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
  <link rel="stylesheet" type="text/css" href="css/style.css">
  <link rel="stylesheet" type="text/css" href="css/userlogin.css?2">
...
<body>
  <div class="container text-center">
    <div class="div-center">
      <img src="resource/images/new/asset/login/logox.png" width="280px" style="margin-bottom: 10px;">
      <div class="container" style="border: 3px solid #cc9933;">
        ...
        <form id="adlogin" action="database/adminlogin.php" method="post">
          ...
          <div class="form-group">
            <div class="container" style=" position: relative;text-align: center;color: white;">
              <a href="#" onclick="do_login()"><img src="../resource/images/button_yesxx.png" style="width:35%;">
