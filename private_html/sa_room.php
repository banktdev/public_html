        ...
        <div class="row text-white">
          ...
          <div class="col-md-6 mb-2">
            <div class="container frameA" style="background-image: url('resource/images/new/<?php echo $asset_path ?>/FrameD.png'), url('resource/images/new/<?php echo $asset_path ?>/FrameA-2.png');">
              ...
              <div class="row text-center text-white">
                <div class="col-6 col-sm-6 p-0">
                  <img src="./resource/images/deck/0.png" id="pcard1" width="25%">
                  <img src="./resource/images/deck/0.png" id="pcard2" width="25%">
                  <img src="./resource/images/deck/0.png" id="pcard3" width="25%">
                  <h3>PLAYER</h3>
                </div>
                <div class="col-6 col-sm-6 p-0">
                  <img src="./resource/images/deck/0.png" id="bcard1" width="25%">
                  <img src="./resource/images/deck/0.png" id="bcard2" width="25%">
                  <img src="./resource/images/deck/0.png" id="bcard3" width="25%">
                  <h3>BANKER</h3>
                </div>
              </div>
