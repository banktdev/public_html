$(document).ready(function() {
  ...
  switch (sessionStorage.forType) {
    case "10":
      ...
      $('.sidenav').css('background-image', 'url("resource/images/topbar/Sidebar_baccaratone.png")');
      break;
    case "2":
      link.rel = 'stylesheet';
      link.type = 'text/css';
...
function chktie(s) {
  ...
  function showcard(data){
    card = data.split("|");
    document.getElementById("pcard1").src = "./resource/images/deck/"+card[0]+".png";
    document.getElementById("pcard2").src = "./resource/images/deck/"+card[1]+".png";
    document.getElementById("pcard3").src = "./resource/images/deck/"+card[2]+".png";
    document.getElementById("bcard1").src = "./resource/images/deck/"+card[3]+".png";
    document.getElementById("bcard2").src = "./resource/images/deck/"+card[4]+".png";
    document.getElementById("bcard3").src = "./resource/images/deck/"+card[5]+".png";
  }
  function sendWS() {
    $.ajax({
